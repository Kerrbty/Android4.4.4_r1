...
void AndroidRuntime::start(const char* className, const char* options)
{
    ...
    // 创建 main 函数的参数 classname start-system-server 
    stringClass = env->FindClass("java/lang/String");
     ...
     */
    // 找到 public static void main(String args[]) 方法，调用 
    char* slashClassName = toSlashClassName(className);  // className 中的.号全部替换成 / 
    jclass startClass = env->FindClass(slashClassName);  // 加载指定的类 
    if (startClass == NULL) {
